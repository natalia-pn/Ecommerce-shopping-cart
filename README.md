...
This shopping cart is intended for use in eCommerce, to assist visitors to make purchases online. Upon checkout, the software calculates the total of the order.
